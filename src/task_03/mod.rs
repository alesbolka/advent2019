...
pub fn part1() {
    let origin = Point::new(0, 0);
    let wire1 = Wire::parse(TASK_INPUT1, &origin);
    let wire2 = Wire::parse(TASK_INPUT2, &origin);
    let crossings = Wire::find_intersects(&wire1, &wire2);
    println!(
        "Closes intersect: {}",
